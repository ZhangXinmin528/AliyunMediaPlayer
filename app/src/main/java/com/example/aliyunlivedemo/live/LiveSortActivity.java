package com.example.aliyunlivedemo.live;
...
import static com.example.aliyunlivedemo.live.LiveActivity.PARAMS_URL;
...
public class LiveSortActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initViews() {
        ...
        findViewById(R.id.tv_book_reading).setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_book_reading:
                String book_reading = "http://djt-live.boguforum.com/djt/djt_lsd.m3u8";
                intent.putExtra(PARAMS_URL, book_reading);
                break;
            case R.id.tv_lol:
